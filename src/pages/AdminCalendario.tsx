                ...
                <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-2 sm:pt-6 pb-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                        <div className="flex flex-col">
                            <h1 className="text-xl sm:text-2xl font-black text-slate-800 tracking-tight flex items-start sm:items-center gap-2">
                                <span className="shrink-0 mt-[2px] sm:mt-0 text-[1.1em]">📅</span>
                                <span>Gerenciamento de Calendário</span>
                            </h1>
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-4 overflow-y-auto max-h-[75vh]">
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    ...
                                    disabled={saving}
                                    className="flex-1 h-12 rounded-xl bg-slate-100 text-slate-600 font-bold text-base shadow-[0_4px_0_#CBD5E1] hover:bg-slate-200 active:translate-y-[2px] active:shadow-none transition-all disabled:opacity-50"
                                >
                                    Cancelar
                                </button>
                                <button
