...
const MeuPerfil: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#eef4ff] flex flex-col items-center justify-start p-2 lg:p-0 md:gap-y-2 overflow-x-hidden md:overflow-visible text-slate-800">
