    ...
    <div className="bg-[#FBFBFA] rounded-2xl md:rounded-[22px] border border-slate-400/30 md:border-slate-300/40 relative z-10 min-h-[44px] h-full flex flex-col overflow-hidden transition-all duration-300">
      <div className="relative w-full h-9 md:h-[52px] flex items-center">
        ...
        <div className="relative flex items-center justify-between pl-3 pr-2 md:pl-6 md:pr-4 z-20 w-full">
          ...
          <div className="flex flex-row md:flex-col items-center justify-center py-[4px] md:py-[4px] px-[12px] md:px-[10px] rounded-[10px] md:rounded-[8px] text-[12px] md:text-[13px] bg-[#64748b]/15 text-[#475569] leading-[1.1] ml-auto border-[0.5px] border-[#64748b]/20 shadow-[inset_0_1px_4px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.02)]">
