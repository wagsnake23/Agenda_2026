    ...
    <div className="premium-module-bg rounded-[16px] relative z-10 min-h-[44px] h-full flex flex-col overflow-hidden transition-all duration-300 shadow-[0_10px_25px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.05)]">
      ...
      >
        ...
        <div className="relative flex items-center justify-between pl-1.5 pr-1.5 md:pl-6 md:pr-4 z-20 w-full">
          ...
          <div className="flex flex-row items-center justify-center py-[4px] md:py-[6px] px-[12px] rounded-[10px] md:rounded-[8px] text-[12px] md:text-[15px] bg-white/20 md:bg-slate-50 text-white md:text-slate-700 leading-[1.1] ml-auto border-[0.5px] border-white/30 md:border-indigo-200 shadow-[inset_0_1px_4px_rgba(0,0,0,0.05)]">
