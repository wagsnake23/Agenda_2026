...
const MoonPhasesDisplay: React.FC<MoonPhasesDisplayProps> = ({ moonPhases, month }) => {
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl md:rounded-[22px] border border-slate-500/20 md:border-gray-200/50 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.08)] relative z-10 min-h-[44px] h-full flex flex-col overflow-hidden transition-all duration-300">
      <div className="relative w-full h-9 md:h-[52px] flex items-center">
        {/* Faixa de fundo com gradiente horizontal */}
        <div className="absolute inset-0 bg-gradient-to-r from-slate-500/[0.25] to-transparent pointer-events-none" />
          ...
          {moonPhases.map((phase, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[13px] md:text-[14px] font-medium text-[#1F2937] text-center leading-[1.6] uppercase tracking-tighter opacity-90">
                ...
                <span className="text-[11px] md:text-[13px] text-[#475569] mt-0.5 font-semibold leading-[1.6]">
